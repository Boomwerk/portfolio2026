            ...
            <div className="flex flex-wrap justify-center items-center w-full gap-5">
                ...
                <div className="flex flex-col items-center gap-5 p-10 w-xl"> 
                    ...
                    <div className="w-50 flex content-around items-center gap-5 mt-4">
                        ...
                        <div className="flex items-center align-items rounded-full bg-accent p-3">
                            <a href="https://www.linkedin.com/in/yannis-a-65a55b196/" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-linkedin fill-base-100" viewBox="0 0 16 16">
                        ...
                        <div className="flex items-center align-items rounded-full bg-accent p-3">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-github fill-base-100" viewBox="0 0 16 16">
                        ...
                        <div className="flex items-center align-items rounded-full bg-accent p-3">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-twitter-x fill-base-100" viewBox="0 0 16 16">
