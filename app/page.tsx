          ...
          <div className="flex flex-col items-center gap-5 p-10 w-xl">
            ...
            <form className="flex flex-col gap-5 w-full">
              ...
              <label className="input validator w-full">
                ...
                <input type="email" placeholder="exemple@site.com" className="w-full" required />
              </label>

              <div className="validator-hint hidden">Veuillez entrer une adresse email valide </div>

              <label className="input validator w-full">
                <input type="text" placeholder="Objet: " className="w-full" required pattern="[A-Za-z][A-Za-z0-9\-]*" minLength="3" maxLength="30" title="Seul les Lettres, Chiffres, et Tirer"/>
              </label>
              ...
              <label className="textarea validator w-full">
                 <textarea className="textarea w-full" placeholder="Message :" required pattern="[A-Za-z][A-Za-z0-9\-]*" minLength="3" maxLength="30" title="Seul les Lettres, Chiffres, et Tirer"></textarea>
              </label>
